          ...
          <main className="flex-1 p-6 bg-white">
            <div className="flex flex-col lg:flex-row justify-between gap-4">
              ...
              <div
                ...
                className=" relative flex items-center justify-center shadow-sm lg:w-2/3  border border-gray-300 p-4 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-teal-500"
              >
              ...
              <div className="relative shadow-sm border border-gray-300 rounded-lg">
                ...
                <div className="flex rounded-lg  bottom-0 left-0 border p-4   bg-[#2E3A87] text-white w-full">
                  <button
