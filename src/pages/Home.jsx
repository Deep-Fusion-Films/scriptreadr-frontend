          ...
          <div>
            ...
            <div className="text-center text-white ">
              <p className="lg:px-100">
                <i>
                  "ScriptReadr is designed to be easy to use, in just three
                  steps: Upload, select voice or click generate audio to use the
                  default voices, and generate audio"
                </i>
              </p>
            </div>
          </div>
            ...
            <div className="text-center text-white ">
              <p className="lg:px-100">
                <i>
                  ...
                  voice-over-reel, animating your screenplay, or just want to
                  hear your words out loud, Script Readr gives your script a
                  voice. Upload your script, assign voices, and let the
