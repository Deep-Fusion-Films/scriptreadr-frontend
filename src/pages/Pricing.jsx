        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="border rounded-xl shadow-md p-6 bg-white flex flex-col justify-between">
            ...
            <button
              ...
              className="mt-auto py-2 px-4 rounded transition bg-[#2E3A87] hover:bg-gray-600 text-white"
            >
              Pay for One-off
            </button>
          </div>
          ...
          <div className="border rounded-xl shadow-md p-6 bg-white flex flex-col justify-between">
            ...
            <button
              ...
              className='className="mt-auto py-2 px-4 rounded bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 hover:from-yellow-500 hover:to-yellow-700 "'
            >
              Get Starter
            </button>
          </div>
