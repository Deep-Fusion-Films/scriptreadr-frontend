    ...
    <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md mt-20 mb-20">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        ...
        <p className="text-sm text-gray-600">
          ...
          <Link
            to="/termsofuse"
            className="text-[#2E3A87] hover:underline cursor-pointer"
          >
        ...
        {/* Register button */}
        <button className="block text-center w-full bg-[#2E3A87] text-white py-2 rounded-md hover:bg-[#1f2d6f] transition">
          Register
        </button>
